...
twitch_miner = TwitchChannelPointsMiner(
    username="GreenIcing",
    password="BenChar1379!123?",           # If no password will be provided, the script will ask interactively
    ...
    logger_settings=LoggerSettings(
        ...
        discord=Discord(
            webhook_api="https://discord.com/api/webhooks/990517463940743188/LSD0PCpcFbhkmwtf_U--bXJab32O75YjBzb7hWrqgQBcPO8IZbQs1VfbyuguIy_Ij58t",  # Discord Webhook URL
